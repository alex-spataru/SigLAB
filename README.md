...
I have moved this project to a new [home](https://github.com/Serial-Studio/Serial-Studio). Further development of this project shall be done on the [`Serial-Studio`](https://github.com/Serial-Studio/Serial-Studio) repository.
